...
import 'package:my_first_dapp/note.dart';
...
class NotesServices extends ChangeNotifier {
  List<Note> notes = [];
  final String _rpcUri =
      Platform.isAndroid ? 'http://10.0.0.1:7545' : 'http://127.0.0.1:7545';
  final String _wsUrl =
      Platform.isAndroid ? 'http://10.0.0.1:7545' : 'ws://127.0.0.1:7545';
  bool isLoading = true;

  final String _privatekey =
      "4710f94e39e4d9c67b978fe2262d187bfe847d2bb9dfcaed0df44500fe6d96a9";
  ...
  Future<void> getABI() async {
    String abiFile =
        await rootBundle.loadString('builid/contracts/NotesContract.json');
